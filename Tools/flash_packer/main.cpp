...
int main()
{
    ...
    outfile.write((char *)&nElements,sizeof(uint32_t));
    ...
    for (auto it = flashElements.begin(); it != flashElements.end(); ++it)
    {
        ...
        outfile.write((char *)&offset,sizeof(uint32_t));
        crc32 = calcCRC32(crc32, (char *)&offset, sizeof(offset));
        // Write element size
        outfile.write((char *)&element.size,sizeof(uint32_t));
    ...
    // Write CRC32
    outfile.write((char *)&crc32,sizeof(crc32));
